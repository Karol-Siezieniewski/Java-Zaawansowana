package pl.sda.zdjavapol73.homework.enumTasks.task3;
...
public enum TemperatureConverter {
    ...
    public static float convertTemperature(char input, char output, float temp){
           for(TemperatureConverter temperatureConverter : TemperatureConverter.values()){
               if(input == temperatureConverter.input && output == temperatureConverter.output){
